...
# def sample_health_data_image(health_data, **kwargs):
#     """create and return a sample health_data image"""
#     defaults = {
#         'description': 'sample health_data image'
#     }
#     defaults.update(kwargs)
#     return models.HealthDataImage.create(health_data=health_data, **defaults)
...
class PrivateHealthDataApiTest(TestCase):
    ...
    # def test_health_data_limited_to_user(self):
    ...
    #     sample_health_data(biodata=biodata2)
