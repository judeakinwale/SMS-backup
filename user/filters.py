...
class StaffFilter(filters.FilterSet):
    ...
    class Meta:
        ...
        fields = {
            ...
            'specialization__name': ['iexact'],
            'specialization__id': ['exact'],
            'specialization__department__name': ['icontains'],
            'specialization__department__name': ['iexact'],
            'specialization__department__id': ['exact'],
            'specialization__department__faculty__name': ['icontains'],
            'specialization__department__faculty__name': ['iexact'],
            'specialization__department__faculty__id': ['exact'],
            'is_active': ['exact'],
            'is_lecturer': ['exact'],
            'is_bursar': ['exact'],
            'is_IT': ['exact'],
