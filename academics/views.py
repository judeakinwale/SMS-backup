...
class FacultyViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a faculty",
                         operation_summary='create faculty')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all faculty",
                         operation_summary='list faculty')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a faculty",
                         operation_summary='retrieve faculty')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a faculty",
                         operation_summary='update faculty')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a faculty",
                         operation_summary='partial_update faculty')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a faculty",
...
class DepartmentViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="list all departments",
                         operation_summary='list departments')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a department",
                         operation_summary='retrieve department')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a department",
                         operation_summary='update department')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a department",
                         operation_summary='partial_update department')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a department",
...
class SpecializationViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="list all specializations",
                         operation_summary='list specializations')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a specialization",
                         operation_summary='retrieve specialization')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a specialization",
                         operation_summary='update specialization')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a specialization",
                         operation_summary='partial_update specialization')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a specialization",
...
class CourseViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="list all courses",
    ...
    @swagger_auto_schema(operation_description="update a course",
                         operation_summary='update course')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a course",
...
class LevelViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a level",
                         operation_summary='create level')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all levels",
                         operation_summary='list levels')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a level",
                         operation_summary='retrieve level')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a level",
                         operation_summary='update level')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a level",
                         operation_summary='partial_update level')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a level",
...
class SemesterViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a semester",
                         operation_summary='create semester')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all semesters",
                         operation_summary='list semesters')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a semester",
                         operation_summary='retrieve semester')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a semester",
                         operation_summary='update semester')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a semester",
                         operation_summary='partial_update semester')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a semester",
...
class SessionViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a session",
                         operation_summary='create session')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all sessions",
                         operation_summary='list sessions')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a session",
                         operation_summary='retrieve session')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a session",
                         operation_summary='update session')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a session",
                         operation_summary='partial_update session')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a session",
...
class RecommendedCoursesViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="list all recommended courses",
                         operation_summary='list recommended courses')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a recommended course",
                         operation_summary='retrieve recommended course')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a recommended course",
                         operation_summary='update recommended course')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a recommended course",
                         operation_summary='partial_update recommended course')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a recommended course",
