...
class InformationViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a information",
                         operation_summary='create information')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all information",
                         operation_summary='list information')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a information",
                         operation_summary='retrieve information')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a information",
                         operation_summary='update information')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a information",
                         operation_summary='partial_update information')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a information",
...
class NoticeViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a notice",
                         operation_summary='create notice')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all notices",
    ...
    @swagger_auto_schema(operation_description="update a notice",
                         operation_summary='update notice')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a notice",
...
class InformationImageViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create an information image",
                         operation_summary='create information image')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all information images",
                         operation_summary='list information images')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve an information image",
                         operation_summary='retrieve information image')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update an information image",
                         operation_summary='update information image')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update an information image",
                         operation_summary='partial_update information image')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete an information image",
...
class ScopeViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a scope",
                         operation_summary='create scope')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all scopes",
                         operation_summary='list scopes')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a scope",
                         operation_summary='retrieve scope')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a scope",
                         operation_summary='update scope')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a scope",
                         operation_summary='partial_update scope')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a scope",
