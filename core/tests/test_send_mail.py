...
from core.utils import send_results_to_course_adviser, send_sample_email, send_account_creation_email
...
class TestSMTP(TestCase):
    ...
    def test_send_account_creation_email(self):
        result = send_account_creation_email(request, reciepients=['akinwalejude@gmail.com', ])
        self.assertTrue(result)
