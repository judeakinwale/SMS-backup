...
class QuizViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="list all quizzes",
                         operation_summary='list quizzes')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a quiz",
                         operation_summary='retrieve quiz')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a quiz",
                         operation_summary='update quiz')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a quiz",
                         operation_summary='partial_update quiz')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a quiz",
...
class QuestionViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a question",
    ...
    @swagger_auto_schema(operation_description="retrieve a question",
                         operation_summary='retrieve question')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a question",
                         operation_summary='update question')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a question",
                         operation_summary='partial_update question')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a question",
...
class AnswerViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create an answer",
    ...
    @swagger_auto_schema(operation_description="retrieve an answer",
                         operation_summary='retrieve answer')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update an answer",
                         operation_summary='update answer')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update an answer",
                         operation_summary='partial_update answer')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete an answer",
...
class QuizTakerViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="list all quiz takers",
                         operation_summary='list quiz takers')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a quiz taker",
                         operation_summary='retrieve quiz taker')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a quiz taker",
                         operation_summary='update quiz taker')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a quiz taker",
                         operation_summary='partial_update quiz taker')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a quiz taker",
...
class ResponseViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a response (question response)",
                         operation_summary='create response (question response)')
    def create(self, request, *args, **kwargs):
        """create method docstring"""
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(operation_description="list all responses (question responses)",
                         operation_summary='list responses (question responses)')
    def list(self, request, *args, **kwargs):
        """list method docstring"""
        return super().list(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="retrieve a response (question response)",
                         operation_summary='retrieve response (question response)')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a response (question response)",
                         operation_summary='update response (question response)')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a response (question response)",
                         operation_summary='partial_update response (question response)')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a response (question response)",
...
class GradeViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(operation_description="create a grade",
    ...
    @swagger_auto_schema(operation_description="retrieve a grade",
                         operation_summary='retrieve grade')
    def retrieve(self, request, *args, **kwargs):
        """retrieve method docstring"""
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="update a grade",
                         operation_summary='update grade')
    def update(self, request, *args, **kwargs):
        """update method docstring"""
        return super().update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="partial_update a grade",
                         operation_summary='partial_update grade')
    def partial_update(self, request, *args, **kwargs):
        """partial_update method docstring"""
        return super().partial_update(request, *args, **kwargs)

    @swagger_auto_schema(operation_description="delete a grade",
